...
module.exports = app => {
  class MonthServer extends app.Service {
    ...
    * list(pageNum, pageSize) {
      const articles = yield app.mysql.query('select  id,  m_pic, content, type from design_project order by timestamp desc limit ? offset ?;', [ pageSize, (pageNum - 1) * pageSize ]);
      return articles;
    }
